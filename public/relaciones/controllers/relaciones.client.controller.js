...
//Controller obras
angular.module('relaciones').controller('RelacionesController',['$scope','$routeParams','$location','Authentication', 'Obras','Actores','ActoresObras','Relaciones',
	function($scope, $routeParams, $location, Authentication,  Obras, Actores,ActoresObras, Relaciones){
