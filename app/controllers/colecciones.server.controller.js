...
exports.update=function(req,res){
	...
	exports.coleccionByID=function(req,res,next,id){
		Coleccion.findById(id).populate('creador', 'firstName lastName fullName').exec(function(err,coleccion){
			if (err) return next(err);
			if(!coleccion) return next(new Error('Fallo al cargar la coleccion'+ id));
